...
teen rule. In this way, you avoid repeating the teen code 3 times
(i.e. "decomposition"). Define the helper below and at the same indent level
as the main no_teen_sum().'''


def no_teen_sum(a, b, c):
    a = 0 if a in [13, 14, 17, 18, 19] else a
    b = 0 if b in [13, 14, 17, 18, 19] else b
    c = 0 if c in [13, 14, 17, 18, 19] else c
    return sum([a, b, c])
